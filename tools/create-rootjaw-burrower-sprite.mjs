...
const stagingDir = "C:/Users/headc/Documents/prompt_spriter/workspace/staging/enemy-mob-32-rootjaw-burrower";
...
writeFileSync("tools/build-rootjaw-burrower.lua", luaScript);
console.log("Updated tools/build-rootjaw-burrower.lua");
