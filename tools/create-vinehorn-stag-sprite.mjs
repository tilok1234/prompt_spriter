...
const stagingDir = "C:/Users/headc/Documents/prompt_spriter/workspace/staging/enemy-mob-32-vinehorn-stag";
...
writeFileSync("tools/build-vinehorn-stag.lua", luaScript);
console.log("Updated tools/build-vinehorn-stag.lua");
