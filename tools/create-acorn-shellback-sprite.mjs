...
const stagingDir = "C:/Users/headc/Documents/prompt_spriter/workspace/staging/enemy-mob-32-acorn-shellback";
...
writeFileSync("tools/build-acorn-shellback.lua", luaScript);
console.log("Updated tools/build-acorn-shellback.lua");
