...
**Current phase:** Phase 4 - revision batches underway  
**Plan:** `docs/MASTER_PLAN.md`, version 0.3  
...
`npm.cmd run check` passes the Phase 3 gate with 5 test files and 20 tests.
...
- The style uses 6-12 recommended opaque colors and a maximum of 16.
